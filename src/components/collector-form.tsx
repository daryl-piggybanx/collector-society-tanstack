            ...
            <div className="flex justify-between mt-8">
              {currentPhase > 1 && (
                <Button
                  variant="outline"
                  onClick={handleBack}
                  className="flex items-center gap-2 bg-amber-950/40 border-amber-400/30 text-amber-100 hover:bg-amber-800/50 hover:text-amber-50"
                >
                  <ChevronLeft size={16} />
                  Back
                </Button>
              ...
              {currentPhase < totalPhases && (
                <Button
                  ...
                  className="ml-auto flex items-center gap-2 bg-amber-600 hover:bg-amber-500 text-amber-50"
                >
                  Next
