    ...
    <motion.div variants={containerVariants} initial="hidden" animate="visible" exit="exit">
      ...
      <motion.div variants={itemVariants} className="space-y-8">
        <div className="space-y-3">
          <Label htmlFor="pieceCount" className="text-lg text-amber-200">
        ...
        <div className="space-y-3">
          <Label className="text-lg text-amber-200">What is your favorite variation? (Optional)</Label>
                ...
                <Label
                  ...
                  className={`flex items-center p-4 rounded-lg border-2 cursor-pointer transition-all ${
                    formData.favoriteVariation === variation
                      ...
                      : "border-amber-400/30 bg-amber-950/40 hover:border-amber-400/60"
                  }`}
                >
                  <RadioGroupItem
                    value={variation}
                  ...
                  <div className="ml-3 flex items-center">
                    <Sparkles
                      size={18}
                      className={`mr-2 ${
                        formData.favoriteVariation === variation ? "text-amber-300" : "text-amber-400/50"
                      }`}
                    />
                    <span className="text-amber-100">{variation}</span>
                  </div>
                </Label>
              </motion.div>
            ))}
